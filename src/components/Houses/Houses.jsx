...
const housesData = [
  {
    ...
    description:
      "The visionaries who bend light to their will, creating spectacles of illumination and visual arts that transcend conventional sight.",
  ...
  },
  {
    ...
    description:
      "Dwelling in shadow and mystery, they harness darkness itself to create performances that reveal the beauty hidden within the void.",
    color: "var(--house-nyx)",
    members: 98,
    achievements: 7,
  ...
  },
  {
    ...
    description:
      "Masters of sound and voice who carry tales across vast distances, weaving narratives that dance on the air like desert winds.",
  ...
  },
  {
    ...
    description:
      "Passionate creators whose arts burn with intensity and transformation, forging new forms from the raw materials of imagination.",
...
const Houses = () => {
  ...
  useEffect(() => {
    ...
    const egyptianSymbols = document.querySelectorAll(
      `.${styles.egyptianSymbol}`
    );
  ...
  return (
    <section id="houses" className={styles.houses} ref={sectionRef}>
      ...
      <div className={styles.egyptianSymbols}>
        <img
          src="/svgs/ankh.svg"
          className={`${styles.egyptianSymbol}`}
          style={{
            top: "15%",
            left: "5%",
            width: "70px",
        ...
        />
        <img
          src="/svgs/sphinx-egypt.svg"
          className={`${styles.egyptianSymbol}`}
          style={{ bottom: "20%", right: "8%", width: "100px" }}
          alt=""
        />
        <img
          src="/svgs/pharaoh.svg"
          className={`${styles.egyptianSymbol}`}
          style={{ top: "40%", left: "3%", width: "80px" }}
          alt=""
        />
        <img
          src="/svgs/mummy-man.svg"
          className={`${styles.egyptianSymbol}`}
          style={{
            top: "25%",
            right: "12%",
        ...
        />
        <img
          src="/svgs/hieroglyphs-ancient-culture-egyptian-pyramid.svg"
          className={`${styles.egyptianSymbol}`}
          style={{ bottom: "35%", left: "12%", width: "60px" }}
          alt=""
        />
        <img
          src="/svgs/hieroglyphs-ancient-culture-egyptian-pyramid-10.svg"
          className={`${styles.egyptianSymbol}`}
          style={{
            top: "10%",
            right: "25%",
        ...
        />
        <img
          src="/svgs/egyptian-egypt-egyptian-ancient.svg"
          className={`${styles.egyptianSymbol}`}
          style={{ top: "55%", right: "20%", width: "90px" }}
          alt=""
        />
